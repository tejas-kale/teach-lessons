...
for (const name of ['0003-dags-and-back-door-identification.html', '0004-emulate-a-target-trial.html', '0006-weighting-standardisation-and-aipw.html', '0014-longitudinal-g-methods.html']) {
  ...
  if (!html.includes('Evidence-gap')) errors.push(`${name}: missing evidence-gap label`);
}
...
console.log(`Verified ${lessons.length} lessons, equal-word quiz options, local links, shared assets and evidence-gap labels.`);
